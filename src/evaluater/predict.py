...
import json
import argparse
from utils.utils import calc_mean_score, save_json, save_csv
...
def image_dir_to_json(img_dir, img_type=IMG_TYPE):
...
def main(base_model_name, weights_file, image_source, img_format=IMG_TYPE):
    # load samples
    if os.path.isfile(image_source):
        ...
        json_file = os.path.join(image_dir, 'predictions.json')
        csv_file = os.path.join(image_dir, 'predictions.csv')
